...
class CleanProducts extends StatefulWidget {
  const CleanProducts({Key? key}) : super(key: key);

  @override
  State<CleanProducts> createState() => _CleanProductsState();
}

class _CleanProductsState extends State<CleanProducts> {
  @override
  void initState() {
    //cleanProducts. = 0;
    super.initState();
  ...
  // var qu = cleanProducts.first.quantity;
  @override
              ...
              children: [
                Expanded(
                  child: GridView.builder(
                    ...
                    itemCount: cleanProducts.length,
                  ),
                ),
  ...
  Widget buildGridItem(AppCubit cubit, index, context,
          List<exchangeProduct> products, BoxConstraints constraints) =>
      Stack(
        children: [
          Card(
            elevation: 3,
                        ...
                        IconButton(
                            onPressed: () {
                              setState(() {
                                ...
                                cubit.allpoints = cubit.cartItems[index].points;
                              });
                            },
                            icon: Icon(
                              Icons.plus_one,
